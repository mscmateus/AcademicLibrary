...
class JFormFieldAcademicLibraryTrabalho extends JFormFieldList
{
	...
	protected function getOptions()
	{
		...
		$query->select('tra_id,tra_tema','tra_titulo','tra_ano','tra_cat_id','tra_nota'
		...
		if ($messages)
		{
			foreach ($messages as $message)
			{
				...
				$message->tra_titulo,$message->tra_ano,$message->tra_cat_id,$message->tra_nota,$message->tra_palavras_chaves,
